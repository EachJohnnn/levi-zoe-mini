...
<p align="center">
  <b>一款温馨的微信小程序 · 一起记录菜谱、规划晚餐、探索餐厅</b>
</p>
...
**Levi & Zoe 小厨房** 是一款面向亲密关系、室友或独自生活的用户的微信小程序。无论你是情侣、合租室友还是一个人打理三餐，它都能帮你：

- 🍳 用 AI 生成并保存喜欢的菜谱
- 📋 建立「美食通缉榜」，收藏想吃的菜
- 🍽️ 一键生成今晚菜单，指定谁负责哪道菜
- 🛒 自动生成购物清单
- 🗺️ 记录想去的餐厅，按距离/菜系筛选，查看地图并一键导航

## ✨ 功能特性

### 🍳 做菜管理

从记录菜谱到生成今晚菜单，一站式解决三餐安排：
...
| 💕 共享空间 | 邀请另一半或室友加入，一起维护数据 |

## 📸 截图预览

> 这里可以补充小程序各页面的截图，例如：首页、菜品库、今晚菜单、餐厅地图等。
>
> 示例占位：
> - 首页：今晚菜单与通缉榜预览
> - 菜品库：分类筛选与搜索
